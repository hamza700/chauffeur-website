...
export default function BookingDetailsPage() {
      ...
      <div className="container mx-auto px-4 py-16">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>You need to be signed in to view booking details.</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-gray-50 min-h-screen">
      ...
      >
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">Booking Details</h1>
        <Card className="shadow-lg">
          <CardHeader className="bg-primary text-white">
            <CardTitle className="text-3xl">Booking {bookingDetails.id}</CardTitle>
            <CardDescription className="text-primary-foreground">
              Status: <span className="font-semibold">{bookingDetails.status}</span>
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
              ...
              >
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center text-gray-700">
                    ...
                    <span className="ml-2">{bookingDetails.pickupLocation}</span>
                  </li>
                  <li className="flex items-center text-gray-700">
                    <MapPin className="mr-3 h-5 w-5 text-primary" />
                    <span className="font-medium">To:</span>
                    <span className="ml-2">{bookingDetails.dropoffLocation}</span>
                  </li>
                  <li className="flex items-center text-gray-700">
            ...
            >
              ...
              <p className="flex items-center text-gray-700">
                ...
                <span className="ml-2 text-xl font-bold text-primary">${bookingDetails.price.toFixed(2)}</span>
              </p>
            </motion.div>
          </CardContent>
