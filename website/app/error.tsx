      ...
      >
        <Card className="max-w-md w-full shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl font-bold text-primary mb-2">Oops! Something went wrong</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-4">
              ...
              <Button variant="link" className="w-full" onClick={() => window.location.reload()}>
                Refresh the page
              </Button>
            </div>
          </CardContent>
